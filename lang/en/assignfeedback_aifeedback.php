...
$string['maxassignmentdescchars_help'] = 'Maximum number of assignment description characters included in the AI prompt.';
$string['maxsubmissionchars'] = 'Submission text character limit';
$string['maxsubmissionchars_help'] = 'Maximum number of submission text characters included in the AI prompt.';
$string['maxissuechars'] = 'Extraction notes character limit';
$string['maxissuechars_help'] = 'Maximum number of extraction note characters included in the AI prompt.';
